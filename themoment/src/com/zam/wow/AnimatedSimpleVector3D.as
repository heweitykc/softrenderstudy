package com.zam.wow
{
    ...
    public class AnimatedSimpleVector3D extends Object
    {
        public var _times:Vector.<uint>;
        public var _data:Vector.<Vector3D>;

        public function AnimatedSimpleVector3D()
        {
            return;
        }// end function
        ...
        public function read(param1:ByteArray, param2:Boolean = true) : void
        {
            ...
            this._times = new Vector.<uint>(_loc_4);
            _loc_3 = 0;
            while (_loc_3 < _loc_4)
            {
                
                this._times[_loc_3] = param1.readUnsignedInt();
                _loc_3++;
            }
